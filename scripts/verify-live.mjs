...
for(const [lang,q] of [['es','casa'],['es','hablo'],['es','tener ganas de'],['es','al aire libre'],['ja','食べる'],['ja','気になる'],['zh','你好'],['en','apple'],['en','went'],['en','look after'],['en','zzqqxxnonexistentword88219']]){
 ...
 if(q==='al aire libre')assert.equal(d.results[0].headword,'al aire libre');
