import {validateWord,mergeWords,parseBackup} from './model.js';
let connection;
...
export async function backup(){return {app:'moa-vocab',version:1,exportedAt:new Date().toISOString(),words:await all()}}
